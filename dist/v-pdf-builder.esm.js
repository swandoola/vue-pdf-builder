  ...
  methods: {
    deleteRow(row) {
      if (confirm("Are you sure you wish to remove this row and all its contents? This cannot be undone!?")) {
        var indexToDelete = this.templateItems.findIndex(x => x.id === row.id);
  ...
  methods: {
    updateTemplate() {
      window.axios.post(this.updateUrl, {
        ...
        this.loadedTemplate = data.template; // console.log("alert", data);
      });
    },
...
var __vue_render__$i = function () {
  ...
  }, [_vm.currentSelectedItem ? _c('form-builder-options', {
    staticClass: "mb-3",
    attrs: {
      "current-selected-row": _vm.currentSelectedRow,
      "current-selected-col": _vm.currentSelectedCol,
